...
<div style="background: url('http://test.san-kras.ru/images/system/texture-mail.png') repeat;padding: 45px;">
    ...
    <footer style="font-family: Arial,sans-serif;">
        <ul style="float: left;line-height: 1.4;color: #9db7d1">
            ...
            <li><a href="http://test.san-kras.ru/#reviews" target="_blank" style="color: #9db7d1;font-size: 14px;">Отзывы</a></li>
            <li><a href="http://test.san-kras.ru/#contacts" target="_blank" style="color: #9db7d1;font-size: 14px;">Контакты</a></li>
        </ul>
        <div style="float: right;width: 300px;line-height: 1.9;margin-top: 11px;">
            ...
            <div style="float: right;margin-top: -9px;">
                ...
                <a href="https://vk.com/away.php?to=https%3A%2F%2Fok.ru%2Fgroup%2F57443680583734" target="_blank" style="display: block;margin-bottom: 4px;height: 40px;"><img src="http://test.san-kras.ru/images/system/ok.png" alt="ok"></a>
                <a href="https://vk.com/away.php?to=https%3A%2F%2Fwww.facebook.com%2Fgroups%2F951386194924056%2F" target="_blank" style="display: block;margin-bottom: 4px;height: 40px;"><img src="http://test.san-kras.ru/images/system/facebook.png" alt="facebook"></a>
            </div>
