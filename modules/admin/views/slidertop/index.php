...
$this->title = 'Верхний слайдер';
?>
<h1><?php echo 'Слайдеры > ' . $this->title; ?></h1>
<div class="row-fluid">
    <a href="<?php echo Url::toRoute('slidertop/edit'); ?>" class="btn btn-success">Добавить слайд</a>
</div>
<div class="row-fluid">
    <table class="table table-striped table-hover ">
        ...
        <?php foreach ($slides as $slide) { ?>
            <tr>
                ...
                <td><img data-src="<?php echo Yii::$app->params['params']['pathToImage'] . Slides::IMG_FOLDER_SLIDER_TOP . 'admin_' . $slide->image; ?>"></td>
                ...
                <td>
                    <div class="btn-group-vertical">
                        <a href="<?php echo Url::toRoute(['slidertop/edit', 'id' => $slide->id]); ?>" class="btn btn-default btn-xs">Редактировать</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.btn-activate').click(function () {
            var $this = $(this);
            activeAjax($this, '<?php echo Url::toRoute('slidertop/active'); ?>');
        });
        ...
        $('input[name="show_position"]').change(function() {
            ...
            var value = $(this).val();
            $.ajax({
                url: '<?php echo Url::toRoute('slidertop/sort'); ?>',
                type: 'get',
                dataType: 'json',
