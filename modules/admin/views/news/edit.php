...
?>
<h1><?php echo 'Новости > ' . $this->title; ?></h1>
...
<div class="form-group">
    <div class="col-lg-10 col-lg-offset-2">
        <a href="<?php echo Url::toRoute(['news/index']); ?>" class="btn btn-warning">Вернуться к списку</a>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.glyphicon-remove').click(function() {
            ...
            $.ajax({
                url: '<?php echo Url::toRoute('news/delete-slide'); ?>',
                type: 'get',
                dataType: 'json',
                data: {newId: newId},
