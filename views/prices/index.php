        ...
        <section class="price-list clear">
            ...
            <div class="table-description">
                <ul>
                    ...
                    <li>На все сантехнические работы действует гарантия, срок которой зависит от качетсва используемых материалов. Длительность гарантии варьируется от 1 года до 5 лет.</li>
                    <li>К стоимости заказа может применяться коэффициент надбавки 1.2 - 1.5, если сантехническое оборудование и коммуникации находятся в труднодоступном месте.</li>
