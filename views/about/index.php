        ...
        <div class="about-block">
            <div class="text clear">
                <div class="txt txt-1">
                    ...
                    <p>Почему люди доверяют одним компаниями, но не пользуются услугами других? Мы в Sankras долго думали над этим, пока не поняли, что, наверное, главным критерием при выборе поставщика каких-либо услуг является репутация.</p>
                ...
                <div class="txt txt-2">
                    ...
                    <p>Мы не пытаемся заниматься сторонними делами (для этого у нас есть широкий список компаний, с которыми мы сотрудничаем по самым разным вопросам), все наши усилия сосредоточены именно на  монтаже сантехнических коммуникаций.</p>
