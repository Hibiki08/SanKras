...
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Система автополива в Краснодаре. Компания SanKras'
]);
$this->registerMetaTag([
    'name' => 'keywords',
        ...
        <div class="width clear">
            ...
            <div class="more-text clear">
                <div class="txt txt-1">
                    ...
                    <p>Компания SanKras производит монтаж систем автополива в Краснодаре и Краснодарском крае уже более пяти лет.</p>
                ...
                <div class="txt txt-2">
                    <p>Компания SanKras предоставляет своим заказчикам возможность оборудовать на своем участке систему автополива используя услугу <span class="red">Эконом пакет</span>.</p>
                    ...
                    <p>Компания SanKras предоставляет <span class="red">сервисное обслуживание</span> системы автополива стоимостью от 12 тысяч:</p>
                    <ul>
