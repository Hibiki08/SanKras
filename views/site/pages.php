                ...
                <div class="preview">
                    <?php if(!empty($service['image']) || !empty($service['video'])) {
                        if (($service['img_video'] == 1) || ($service['img_video'] == 2 && empty($service['video']))) { ?>
                            <img class="img-video" src="<?php echo Yii::$app->params['params']['pathToImage'] . Services::IMG_FOLDER . 'page(' . $service['id'] . ')/' . $service['image']; ?>" alt="<?php echo $service['title']; ?>">
                        <?php } else {
                            ...
                            <?php foreach ($service->projectdocs as $doc) {?>
                                ...
                                <div class="item" style="width:<?=$width?>px">
                                    <a class="fancy" rel="carousel1" href="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesProjectdocs::IMG_FOLDER . 'page(' . $service['id'] . ')/' . $doc['image']; ?>" title="<?php echo $doc['name']; ?>">
                                        <img src="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesProjectdocs::IMG_FOLDER . 'page(' . $service['id'] . ')/' . 'mini_slider_' . $doc['image']; ?>"  alt="<?php echo $doc['name']; ?>"/>
                                    </a>
									<div class="name">
                    ...
                    <div class="flexslider" style="margin:0px 50px 10px;">
                        <ul class="slides">
                            <?php foreach ($service->slides as $slide) {?>
                                <li>
                                    <a class="fancy" rel="carousel2" href="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesSlides::IMG_FOLDER . 'page(' . $service['id'] . ')/' . $slide['slide']; ?>" title="<?php echo $slide['text']; ?>">
                                        <img src="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesSlides::IMG_FOLDER . 'page(' . $service['id'] . ')/' . $slide['slide']; ?>"  alt="<?php echo $slide['text']; ?>"/>
                                    </a>
									<div class="name">
                        ...
                        <div style="text-align:center">
                          ...
                          <span class="_count"><?=count($service->slides)?> фотографии</span>
							...
							<?php foreach ($service->slides as $slide) { ?>
                                <div class="wrap">
                                    <a class="fancy" rel="carousel2" href="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesSlides::IMG_FOLDER . 'page(' . $service['id'] . ')/' . $slide['slide']; ?>" title="<?php echo $slide['text']; ?>">
                                        <img src="<?php echo Yii::$app->params['params']['pathToImage'] . ServicesSlides::IMG_FOLDER . 'page(' . $service['id'] . ')/' . 'mini_slider_' . $slide['slide']; ?>"  alt="<?php echo $slide['text']; ?>"/>
                                    </a>
                                </div>
                            <?php } ?>
                      </div>
