...
<section class="quality" id="better">
    ...
    <div class="columns clear width">
        <div class="col wow zoomIn">
            ...
            <div>В течение гарантийного срока мы <strong>бесплатно</strong> устраним возможные неисправности монтажа. Однако мы уверены в высоком качестве нашей работы, потому что она <span style="letter-spacing: -1px">выполняется квалифицированными специалистами</span> с использованием надежных материалов.</div>
        </div>
