...
$this->title = 'Монтаж в квартире Краснодар';
?>
<section class="more-flat" id="more">
    <section class="description">
        <div class="width clear">
            <h2 class="title title-big">монтаж сантехнических коммуникаций в квартире «под ключ»</h2>
            <figure>
            ...
            <div class="text">
                ...
                <p>Компания СанКрас за последний год выполнила монтаж в 22 квартирах и наши специалисты точно знают, с чего начинается и чем заканчивается ремонт ванной комнаты.</p>
            </div>
        </div>
    </section>
    <section class="steps">
    ...
    <?php echo Works::widget(['filter' => ['works.cat_id' => 2]]); ?>
    <section class="pakage">
        <div class="width">
            ...
            <div class="pdf">
                <span class="title-big">Посмотреть полный прайс-лист</span><a target="_blank" href="<?php echo Yii::$app->params['params']['pathToFile']; ?>Price_San-Kras_2016-2017.pdf"><button class="pulse exo">Прайс-лист</button></a>
            </div>
        </div>
    </section>
