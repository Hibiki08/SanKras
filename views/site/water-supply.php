    ...
    <section class="description">
        <div class="width clear">
            ...
            <div class="more-text clear">
                <div class="txt txt-1">
                    <figure><img class="lazyload" data-src="<?php echo Yii::$app->params['params']['pathToImageSystem'] . 'water-supply.jpg'; ?>" alt="монтаж водоснабжения" title="монтаж водоснабжения"></figure>
